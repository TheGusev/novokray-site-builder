...
const HUBS: Hub[] = [
  {
    ...
    metaDescription:
      "Профессиональное уничтожение клопов, тараканов, блох, муравьёв, ос и грызунов в Новосибирске. Горячий и холодный туман, гарантия до 12 мес., выезд за 60 минут.",
    intro:
      "Уничтожение вредителей в Новосибирске под ключ: бригада Дез-Федерация выводит клопов, тараканов, блох, муравьёв, ос и грызунов в квартирах, частных домах, кафе, офисах и складах. Цена от 1 500 ₽, гарантия по договору до 12 месяцев, выезд день в день.",
    intro2:
  ...
  },
  {
    ...
    metaDescription:
      "Санитарная обработка квартир, офисов и заведений в Новосибирске: дезинфекция, удаление плесени, обработка после жильцов. Лицензия Роспотребнадзора, гарантия по договору.",
    intro:
  ...
  },
  {
    ...
    metaDescription:
      "Акарицидная обработка от клещей, уничтожение комаров и борщевика на участке. Безопасные препараты, гарантия на сезон, выезд по Новосибирску и области.",
    intro:
  ...
  },
  {
    ...
    metaDescription:
      "Специальные услуги санитарной службы в Новосибирске: озонирование от запахов, аварийная сушка квартиры после потопа, фумигация зерна, дезодорация. Выезд за 60 минут.",
    intro:
