...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: `${SITE.domain}/logo.png` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: `${SITE.name} — Санитарная служба №1 в Новосибирске` },
      ...
      { name: "twitter:image", content: `${SITE.domain}/logo.png` },
    ],
    links: [
