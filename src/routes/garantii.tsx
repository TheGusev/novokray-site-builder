...
function GuaranteesPage() {
  ...
  const guarTable = [
    ...
    { svc: "Обработка участка от клещей", term: "до 1,5 мес.", cond: "повторная обработка бесплатно при дожде в первые 4 часа" },
  ...
  const afterList = [
    ...
    "Соблюдать рекомендации из памятки после обработки",
    "При появлении единичных особей — сразу звонить, повторная обработка по гарантии бесплатно",
  ];
  const faqGuar = [
    ...
    { q: "Что считается «возвратом проблемы»?", a: "Появление живых особей того же вида через 7+ дней после обработки. Единичная находка может быть остаточной — мы консультируем, а повторную обработку делаем бесплатно." },
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-hero text-primary-foreground">
        <img src={COMMON.documents} alt="Документы по гарантии: договор, акт и сертификат от Дез-Федерация" title="Гарантия на санитарные работы — закреплена в договоре" className="absolute inset-0 h-full w-full object-cover opacity-25" loading="eager" />
