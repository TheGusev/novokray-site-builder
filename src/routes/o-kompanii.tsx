...
function AboutPage() {
  const timeline = [
    { y: "2019", t: "Старт компании", s: "Два специалиста, 2 объекта в день, лицензия Роспотребнадзора." },
    ...
    { y: "2026", t: "38 000+ заявок по РФ", s: "Команда из 28 человек, выезд за 60 минут." },
  ];
  const values = [
    ...
    <>
      ...
      <section className="container-x py-14 md:py-20">
        <Reveal>
          ...
          <h2 className="mt-2 font-display text-3xl font-bold md:text-4xl">Путь от первого выезда до санитарной службы №1</h2>
        </Reveal>
      ...
      <section className="container-x py-14 md:py-20">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          {[
            ...
            { t: "Гарантия с бесплатной повторной обработкой", s: "До 24 месяцев по договору в зависимости от услуги. Если проблема вернётся — приезжаем ещё раз бесплатно." },
          ].map((b, i) => (
