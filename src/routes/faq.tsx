...
const GENERAL = [
  ...
  { q: "Можно ли заказать обработку анонимно?", a: "Да. Специалист приезжает без брендинга на одежде и на нейтральном автомобиле, документы оформляем на ФИО без указания вида услуги в подъезде." },
];
const SAFETY = [
  ...
  { q: "Что входит в стоимость?", a: "Все препараты, выезд по городу, работа специалиста, договор, акт, гарантия. Без скрытых платежей." },
...
const GUARANTEE = [
  ...
  { q: "Что если проблема вернётся?", a: "Звоните — приезжаем повторно бесплатно. Главное — соблюдайте памятку, которую оставляет специалист." },
  ...
  { q: "А если и повторная обработка не помогла?", a: "Делаем третий выезд бесплатно. Если и он не решил проблему, возвращаем 100% стоимости услуги." },
