export const SITE = {
  ...
  founded: 2019,
  /** Дата последней ручной актуализации контента (для dateModified и строки «Актуально на»). */
  contentUpdated: "2026-08-15",
  /** Короткий заголовок для рекламы и социальных превью (до 35 символов). */
  adHeadline: "Санитарная служба в Новосибирске",
