export const SITE = {
  ...
  // SDA / metrics
  // Только для отображения на странице. В JSON-LD (AggregateRating/Review) не
  // попадает: разметка рейтинга вернётся лишь после подключения подтверждённых
  // отзывов с Яндекс.Карт/2ГИС со ссылкой на профиль.
