...
export const GALLERY_META: ImgMeta[] = [
  ...
  {
    alt: "Загрузка профессионального оборудования в сервисный фургон Дез-Федерация",
...
export const BLOG_IMAGE_META: Record<string, ImgMeta> = {
  ...
  "osy-v-dome-pod-kryshey": { alt: "Оса у щели под кровлей частного дома", title: "Осы в доме и под крышей — поиск и удаление гнезда" },
  "zemlyanye-osy-na-uchastke": { alt: "Дачный участок с газоном, где встречаются подземные гнёзда ос", title: "Земляные осы на участке — обработка норы" },
  "ukus-osy-i-shershnya-pomoshch": { alt: "Оса рядом с человеком — риск укуса на даче", title: "Укус осы и шершня — первая помощь" },
  "sredstva-ot-os-i-shershney": { alt: "Препараты и оборудование для уничтожения ос и шершней", title: "Средства от ос и шершней — что работает" },
